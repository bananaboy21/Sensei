...
class Pages:
    ...
    def __init__(self, ctx, *, entries, per_page=12, show_entry_count=True):
        ...
        self.embed = discord.Embed(color=discord.Color(value=000000))
...
class HelpPaginator(Pages):
    ...
    async def show_page(self, page, *, first=False):
        ...
        if hasattr(self, '_is_bot'):
            value ='Need help? Our support server: https://discord.gg/3EDgbbG'
    ...
    async def show_help(self):
        ...
        self.embed.set_footer(text=f'We were on page {self.current_page} before this message. Reverting back to it in 15 seconds')
        await self.message.edit(embed=self.embed)
